...
<!-- String msg1 = (String) request.getAttribute("msg");
	...
	%>
      <h1 style="margin-left:1350px"></h1> -->
...
<script src="https://kit.fontawesome.com/ba687577c5.js" crossorigin="anonymous"></script>
    ...
    <p style="margin-left: 20px;font-size: 18px;">Cake Quantity: 25</p>
            <button style="background-color:  #ce3b3b;height: 50px; width: 190px;color: white;margin-left: 160px;border-radius: 6%;font-size: 19px; "><a href="loginusercontroller" style="text-decoration: none;color: white;">BUY NOW</a></button>
         </div>
            <div style="width: 400px;height: 550px; border-bottom:1px solid #5d5d5d;background-color: rgb(207, 220, 207)">
           ...
           <!--  
            <div style="width: 400px;height: 550px; border-bottom:1px solid #5d5d5d;background-color: rgb(207, 220, 207)">
                ...
                <button style="background-color:  #ce3b3b;height: 50px; width: 190px;color: white;margin-left: 160px;border-radius: 6%;font-size: 19px; "><a href="loginusercontroller" style="text-decoration: none;color: white;">Add to Cart</a></button>
