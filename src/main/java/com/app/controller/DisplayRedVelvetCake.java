...
/**
 * Servlet implementation class DisplayRedVelvetCake
 */
@WebServlet("/DisplayRedVelvetCake")
public class DisplayRedVelvetCake extends HttpServlet {
