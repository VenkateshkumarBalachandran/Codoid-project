...
/**
 * Servlet implementation class displayAnniversaryCake
 */
@WebServlet("/displayAnniversaryCake")
public class displayAnniversaryCake extends HttpServlet {
	private static final long serialVersionUID = 1L;
	UserDAO dao = new UserDAO();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public displayAnniversaryCake() {
        super();
