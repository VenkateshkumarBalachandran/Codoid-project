...
/**
 * Servlet implementation class AddStudentControlleerRedVelvetCake
 */
@WebServlet("/AddStudentControlleerRedVelvetCake")
public class AddStudentControlleerRedVelvetCake extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddStudentControlleerRedVelvetCake() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("BuyRedVelvetCake.jsp");
        ...
        try {
			...
			PreparedStatement pstmt=con.prepareStatement("insert into memberRedvelvet value(?,?,?,?)");
			 pstmt.setInt(1, uid);
