...
/**
 * Servlet implementation class AddStudentControlleerwhiteforest
 */
@WebServlet("/AddStudentControlleerwhiteforest")
public class AddStudentControlleerwhiteforest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddStudentControlleerwhiteforest() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("BuyWhiteForest.jsp");
        ...
        try {
			...
			PreparedStatement pstmt=con.prepareStatement("insert into memberWhite value(?,?,?,?)");
			 pstmt.setInt(1, uid);
